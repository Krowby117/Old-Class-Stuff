...
public class Main
{
    ...
    private static int[][] read(String filename, boolean weighted) throws IOException 
    {
        ...
        //System.out.println("Reading file: " + filename); // debug
        String hold;
    ...
    private static void write(String filename, int[][] adjMatrix, List<Character> bfsResult, List<Character> dfsResult, int[][] adjMatrixWeights,  Map<Character, Integer> dijkstraResult) throws IOException 
    {
